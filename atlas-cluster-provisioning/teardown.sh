...
export TF_VAR_cluster_storage_class="${CLUSTER_STORAGE_CLASS:-SSD}"
export TF_VAR_cluster_disk_size_gb="${CLUSTER_DISK_SIZE_GB:-0}"
export TF_VAR_cluster_backup_enabled="${CLUSTER_BACKUP_ENABLED:-false}"
